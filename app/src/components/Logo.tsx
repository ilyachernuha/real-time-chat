...
export default function Logo(props: ViewProps) {
  return (
    <View {...props}>
      <Svg width={128} height={128} fill="none">
        ...
        />
        <Path fill="url(#b)" d="m30.757 65.651-4.35 7.457.08.136 4.357-7.437-.087-.156Z" />
        <Path fill="url(#c)" d="m17.243 74.35-1.83 3.139 4.286 7.546 1.858-3.304-4.314-7.38Z" />
        <Path fill="url(#d)" d="m108.307 85.008 4.27-7.516-1.786-3.059-4.188 7.55 1.704 3.025Z" />
        <Defs>
          <LinearGradient id="a" x1={-0.621} x2={169.631} y1={65.651} y2={100.447} gradientUnits="userSpaceOnUse">
          ...
          <LinearGradient id="b" x1={-0.622} x2={169.631} y1={65.651} y2={100.447} gradientUnits="userSpaceOnUse">
            <Stop offset={0.005} stopColor="#D900C3" />
            <Stop offset={0.262} stopColor="#8900D9" />
            <Stop offset={0.462} stopColor="#4C42D1" />
            <Stop offset={0.773} stopColor="#1EAEF9" />
          </LinearGradient>
          <LinearGradient id="c" x1={21.748} x2={15.534} y1={79.321} y2={83.049} gradientUnits="userSpaceOnUse">
            <Stop offset={0.296} stopColor="#B201CE" stopOpacity={0.85} />
            <Stop offset={1} stopOpacity={0.7} />
          </LinearGradient>
          <LinearGradient id="d" x1={112.466} x2={103.762} y1={83.049} y2={78.086} gradientUnits="userSpaceOnUse">
